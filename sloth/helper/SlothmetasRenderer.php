...
class SlothmetasRenderer extends DocumentRenderer {
    ...
    $buffer .= '<link rel="manifest" href="/media/tmpl_' . $this->_doc->template . '/site.json">' .
      '<link rel="apple-touch-icon" type="image/png" sizes="180x180" href="/templates/' . $this->_doc->template . '/images/apple-touch-icon.png">' .
      '<link rel="icon" type="image/png" sizes="32x32" href="/templates/' . $this->_doc->template . '/images/favicon-32x32.png">' .
      '<link rel="icon" type="image/png" sizes="16x16" href="/templates/' . $this->_doc->template . '/images/favicon-16x16.png">' .
      '<link rel="mask-icon" type="image/svg" href="/templates/' . $this->_doc->template . '/images/safari-pinned-tab.svg" color="#50617c">';
